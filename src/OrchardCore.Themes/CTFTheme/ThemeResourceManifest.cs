...
namespace OrchardCore.Themes.CTFTheme
{
    public class ThemeResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("CTFTheme-vendor-jQuery")
                .SetUrl("~/CTFTheme/vendor/jquery/jquery.min.js", "~/CTFTheme/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("CTFTheme-vendor-jQuery.slim")
                .SetUrl("~/CTFTheme/vendor/jquery/jquery.slim.min.js", "~/CTFTheme/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("CTFTheme-vendor-bootstrap")
                .SetDependencies("CTFTheme-vendor-jQuery")
                .SetUrl("~/CTFTheme/vendor/bootstrap/js/bootstrap.min.js", "~/CTFTheme/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("CTFTheme-vendor-bootstrap-bundle")
                .SetDependencies("CTFTheme-vendor-jQuery")
                .SetUrl("~/CTFTheme/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/CTFTheme/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("CTFTheme-vendor-bootstrap")
                .SetUrl("~/CTFTheme/vendor/bootstrap/css/bootstrap.min.css", "~/CTFTheme/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineStyle("CTFTheme-bootstrap-oc")
                .SetUrl("~/CTFTheme/css/bootstrap-oc.min.css", "~/CTFTheme/css/bootstrap-oc.css")
                .SetVersion("1.0.0");
				
            manifest
                .DefineStyle("CTFTheme-vendor-font-awesome")
                .SetUrl("~/CTFTheme/vendor/fontawesome-free/css/all.min.css", "~/CTFTheme/vendor/fontawesome-free/css/all.css")
            ...
            manifest
                .DefineScript("CTFTheme-vendor-font-awesome")
            ...
            manifest
                .DefineScript("CTFTheme-js")
                .SetUrl("~/CTFTheme/js/theme.min.js", "~/CTFTheme/js/theme.js");
        }
    }
}
